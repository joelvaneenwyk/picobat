...
#ifndef PBAT_READSCRIPT_H
#define PBAT_READSCRIPT_H
...
/* Open a batch script */
int pBat_OpenBatchScript(struct batch_script_t* script, char* name);
...
void pBat_CopyBatchScript(struct batch_script_t* recv,
...
size_t pBat_GetScriptSize(struct batch_script_t* script, int* restrict err);

char* xstrdup(const char* str);

#endif // PBAT_READSCRIPT_H
